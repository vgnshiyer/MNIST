...
class Network:
    def __init__(self, sizes):
        ...
        self.sizes = sizes
        # x and 1 below represent the number of parameters per neuron in that layer
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        # nabla_w, nabla_b has total gradient for all samples in the mini batch
        self.biases = [b - (eta / len(mini_batch)) * nb for b, nb in zip(self.biases, nabla_b)]

    def backprop(self, x, y):
        """Return a tuple ``(nabla_b, nabla_w)`` representing the gradient for the cost function C_x. ``nabla_b`` and ``nabla_w`` are layer-by-layer lists of numpy arrays similar to self.biases and self.weights"""  # noqa
        ...
        for l in range(2, self.num_layers):  # noqa
            z = zs[-l]
            sp = sigmoid_prime(z)
